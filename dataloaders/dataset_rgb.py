...
class DataLoaderTrain(Dataset):
    def __init__(self, rgb_dir, target_transform=None):
        ...
        train_list = open("train_file.txt", "r")

        Lines = train_list.readlines()
  
        for line in Lines:
            self.clean_filenames.append(os.path.join(rgb_dir, 'clean', line.strip()))
            self.noisy_filenames.append(os.path.join(rgb_dir, 'noisy', line.strip()))
...
class DataLoaderVal(Dataset):
    def __init__(self, rgb_dir, target_transform=None):
        ...
        train_list = open("validation_file.txt", "r")
