...
class DataLoaderTrain(Dataset):
    def __init__(self, rgb_dir, target_transform=None):
        ...
        train_file = open('train_file.txt', 'r')
        filenames = []
        while True:
        ...
        self.clean_filenames = [os.path.join(rgb_dir, 'clean', x) for x in filenames if is_png_file(x)]
        self.noisy_filenames = [os.path.join(rgb_dir, 'noisy', x) for x in filenames if is_png_file(x)]
...
class DataLoaderVal(Dataset):
    def __init__(self, rgb_dir, target_transform=None):
        ...
        validation_file = open('validation_file.txt', 'r')
        filenames = []
        while True:
