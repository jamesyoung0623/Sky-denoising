...
def conv(in_channels, out_channels, kernel_size, bias=True, padding = 1, stride = 1):
    return nn.Conv2d(in_channels, out_channels, kernel_size, padding=(kernel_size//2), bias=bias, stride=stride, padding_mode='reflect')
...
class DenoiseNeXt(nn.Module):
    def __init__(self, conv=conv):
        ...
        modules_body = [RRG(conv, n_feats, kernel_size, reduction, act=act, num_dab=3),
                        RRG(conv, n_feats, kernel_size, reduction, act=act, num_dab=3),
                        RRG(conv, n_feats, kernel_size, reduction, act=act, num_dab=9),
                        RRG(conv, n_feats, kernel_size, reduction, act=act, num_dab=3)]
